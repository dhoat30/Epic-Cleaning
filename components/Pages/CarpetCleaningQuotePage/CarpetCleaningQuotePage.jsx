...
import CarpetCleaningQuoteForm from "./CarpetCleaningQuoteForm";
import styles from "@/components/Pages/MoveOutCleaningQuotePage/MoveOutCleaningQuotePage.module.scss";

const benefits = [
  {
    title: "Deep carpet refresh",
    description: "Hot water extraction carpet cleaning for homes, rentals, and end-of-tenancy work.",
  },
  {
    title: "Stain and odour focus",
    description: "Targeted treatment for traffic marks, spills, pet smells, and built-up grime.",
  },
  {
    title: "Fast Tauranga availability",
    description: "Helpful when inspections, move dates, or open homes are coming up quickly.",
  },
  {
    title: "Certified local team",
    description: "IICRC-trained technicians with professional equipment and insured service.",
  },
];
...
export default function CarpetCleaningQuotePage({
  beforeAfterItems = [],
  accreditations = [],
  stats,
  phoneNumber,
  ...
  return (
    <main className={styles.page}>
          ...
          <div className={`${styles.heroGrid} grid gap-48`}>
            <div className={styles.contentColumn}>
              <div className={`${styles.title} heading1`}>
                <h1>
                  Carpet Cleaning <strong>Quotes</strong>
                </h1>
              </div>
              ...
              >
                Get a fast, no-obligation carpet cleaning quote for Tauranga and
                the Bay of Plenty, including stain treatment, odour removal, and
                move-out carpet work.
              </Typography>
              ...
              <div className={`${styles.proofGrid} grid gap-16 mt-32`}>
                ...
                <div className={styles.equipmentCard}>
                  <Image
                    ...
                    alt="Epic Cleaning professional carpet cleaning equipment"
                    fill
                    sizes="(max-width: 900px) 100vw, 380px"
                  />
                  <div className={styles.equipmentOverlay}>
                    <Typography variant="subtitle1" component="p">
                      Professional carpet extraction equipment for homes,
                      rentals, and high-traffic rooms.
                    </Typography>
                  </div>
                </div>
              </div>
      ...
      <BeforeAfterResults
        ...
        title="See what a proper carpet clean can achieve"
      />
          ...
          <div className={`${styles.trustGrid} grid gap-24`}>
            <div className={styles.trustCopy}>
              ...
              <Typography variant="h3" component="h2" className={styles.trustTitle}>
                A carpet-cleaning team that turns up with the right gear.
              </Typography>
              <Typography
                variant="body1"
                component="p"
              ...
              >
                Proper carpet cleaning needs more than a quick surface pass.
                Epic Cleaning uses professional extraction equipment, trained
                technicians, and insured service to help lift grime, improve
                presentation, and get carpets ready for living, renting, or sale.
              </Typography>
            </div>
